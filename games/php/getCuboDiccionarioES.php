...
if( $nivel == 1 || $nivel == 2){
	...
	$query = "SELECT * FROM $tabla WHERE parte='prefijo' AND nivel='$nivel' AND idioma='es' ORDER BY RAND() LIMIT 1";	
	...
	$id = $fila1['id'];
	$query = "SELECT * FROM $tabla WHERE parte='prefijo' AND nivel='$nivel' AND idioma='es' AND id!='$id' ORDER BY RAND() LIMIT 0,1 ";	
	$result= mysql_query($query)or die(mysql_error());
	...
	$id2 = $fila2['id'];
	$query = "SELECT * FROM $tabla WHERE parte='prefijo' AND nivel='$nivel' AND idioma='es' AND id!='$id' AND id!='$id2' ORDER BY RAND() LIMIT 0,1 ";	
	$result= mysql_query($query)or die(mysql_error());
	...
	$query = "SELECT * FROM $tabla WHERE parte='sufijo' AND nivel='$nivel' AND idioma='es' ORDER BY RAND() LIMIT 1";	
	$result= mysql_query($query)or die(mysql_error());
	...
	$id = $fila4['id'];
	$query = "SELECT * FROM $tabla WHERE parte='sufijo' AND nivel='$nivel' AND idioma='es' AND id!='$id' ORDER BY RAND() LIMIT 0,1";	
	$result= mysql_query($query)or die(mysql_error());
	...
	$id2 = $fila5['id'];
	$query = "SELECT * FROM $tabla WHERE parte='sufijo' AND nivel='$nivel' AND idioma='es' AND id!='$id' AND id!='$id2' ORDER BY RAND() LIMIT 0,1";	
	$result= mysql_query($query)or die(mysql_error());
